...
export default function UserMetaCard() {
  ...
  const initialUser: UserMeta | null = storedUser
    ? JSON.parse(storedUser)
    : null;

  const [user, setUser] = useState<UserMeta | null>(initialUser);
  const [imageUrl, setImageUrl] = useState<string>(initialUser?.imageUrl || "");
  ...
  useEffect(() => {
    const onUserUpdated = (event: Event) => {
      ...
      const updated = custom.detail as UserMeta;
      setUser(updated);
  ...
  const locationText = [user.city, user.countryCode]
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <img src={getImageSrc(imageUrl || user.imageUrl)} alt="user" />
            </div>
            ...
            <div className="custom-scrollbar max-h-[60vh] overflow-y-auto px-2 pb-3">
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div className="col-span-2">
                  ...
                  <Input
                    type="text"
                    placeholder="/images/imagedefault.png"
                    value={imageUrl}
